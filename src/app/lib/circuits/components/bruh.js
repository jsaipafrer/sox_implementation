...
function padMessage(message) {
    ...
    let res = new Array(message.length / BLOCK_SIZE);
...
function sha256(msg) {
    ...
    let msgBytes = Array.from(new TextEncoder().encode(msg));
...
console.log(sha256("bruh"));
console.log(sha256(""));
console.log(sha256("ABFBASDFJASDFJAIOSEFIABSVANSIFUHN  FAILSIBFASUNFAIUSFNASUDIFNASFU"));
