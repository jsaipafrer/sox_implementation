INSERT INTO contracts (
    ...
    commitment, encryption_key, encrypted_file_name, accepted
) VALUES (
    ...
    8, 10, 5, 0, 60, 'default', 'commit', 'encryption_keyy', 'uploads/1.enc', 0
);
...
INSERT INTO contracts (
    ...
    33, 25, 10, 0, 120, 'default', 'commit', 'encryption_keyy','uploads/1.enc',  1
);
...
INSERT INTO contracts (
    ...
    15, 15, 7, 0, 90, 'default', 'commit', 'encryption_keyy','uploads/1.enc',  1
);
...
INSERT INTO contracts (
    ...
    tip_completion, tip_dispute,
    protocol_version, timeout_delay, algorithm_suite,
    commitment, encryption_key, encrypted_file_name, accepted, sponsor
) VALUES (
    ...
    21, 20, 8, 0, 75, 'default', 'commit', 'encryption_keyy','uploads/1.enc',  1, "Stéphane Sponsor"
);
...
INSERT INTO contracts (
    ...
    156.7, 30, 12, 0, 180, 'default', 'commit', 'encryption_keyy','uploads/1.enc',  1, "Στεφανος Σπονσορου"
);
...
INSERT INTO contracts (
    ...
    44.7, 35, 12, 0, 110, 'default', 'commit', 'encryption_keyy','uploads/1.enc',  1, "Stephen Sponsor"
);
