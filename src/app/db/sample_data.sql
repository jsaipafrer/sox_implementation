...
INSERT INTO contracts (
    ...
    21, 20, 8, 0, 75, 'default', 1, "Stéphane Sponsor"
);
...
INSERT INTO contracts (
    ...
    156.7, 30, 12, 0, 180, 'default', 1, "Στεφανος Σπονσορου"
);
...
INSERT INTO contracts (
    ...
    44.7, 35, 12, 0, 110, 'default', 1, "Stephen Sponsor"
);

INSERT INTO disputes VALUES (
    4, "SB_pk1", "SV_pk1", "proofb1.bin", "proofv1.bin"
);

INSERT INTO disputes VALUES (
    6, "SB_pk2", NULL, "proofb1.bin", NULL
);
